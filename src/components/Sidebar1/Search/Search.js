...
function Search() {
    ...
    return (
        <div className="search" id="search-input">
            ...
            <input value={(data.start.properties.name !== null)?data.start.properties.name:data.start.geometry.coordinates.join(',')} placeholder="Choose a place..."  type="text" className="search__input" onChange={changeStart} onFocus={focusHandle} onBlur={blurHandle} />

            ...
            <div className="direction">
                ...
                <div className="direction__input">
                    <div className="direction__input-start">
                        ...
                        <input type="text" id="input-start" value={(data.start.properties.name!==null)?data.start.properties.name:data.start.geometry.coordinates.join(',')} placeholder="Chọn điểm bắt đầu..." onChange={changeStart}  onFocus={focusHandle} onBlur={blurHandle} />
                    </div>
